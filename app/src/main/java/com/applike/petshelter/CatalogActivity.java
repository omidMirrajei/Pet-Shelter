...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertDummyData() {
        ...
        values.put(PetEntry.COLUMN_PET_NAME, "Asxel");
        values.put(PetEntry.COLUMN_PET_BREED, "MongolMan");
        ...
        int message;
        if (newUri == null) message = R.string.editor_insert_pet_failed;
        else message = R.string.editor_insert_pet_successful;
